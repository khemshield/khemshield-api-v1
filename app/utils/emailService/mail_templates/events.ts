export const generateEventRegisterHTMLTemp = (option: { name?: string }) => {
  return `
    ...
    <ul>
      ...
      <li>Venue Google Meet: Sessions will generally run from 4:00 PM to 6:00 PM WAT, with some exceptions. You will receive the link to join each day. However, if you joined the program on or after September 24th, feel free to use the following details to join the sessions:</li>
    </ul>
